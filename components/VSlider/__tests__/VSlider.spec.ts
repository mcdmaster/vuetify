...
describe.skip('VSlider.ts', () => {
  ...
  it('should render component with ticks and match a snapshot', async () => {
    ...
    expect('Invalid prop: custom validator check failed for prop "ticks"').toHaveBeenCalled()
  ...
  it('should render component with thumbLabel and match a snapshot', async () => {
    ...
    expect('Invalid prop: custom validator check failed for prop "thumbLabel"').toHaveBeenCalled()
