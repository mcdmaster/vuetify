...
describe.skip('VItem', () => {
  ...
  it('should warn if missing default scopedSlot', () => {
    ...
    expect('v-item is missing a default scopedSlot').toHaveBeenCalled()
    expect(itemWarning).toHaveBeenCalled()
  })
  ...
  it('should warn if multiple elements', () => {
    ...
    expect('v-item should only contain a single element').toHaveBeenCalled()
    expect(itemWarning).toHaveBeenCalled()
  })
